...
def main(): 
    ...
    for seed in seeds:
        ...
        consensus_file = "Experiments/lumc_subsample/03_50/gr_25712/seed_" + seed + '/consensus.tsv'
        reads_file = "Experiments/lumc_subsample//03_50/gr_25712/seed_" + seed + '/communities.tsv'
        ...
        for i, read in reads_region.iterrows():
            ...
            diff = min_ed - min_contig_ed
            diff_per_seed[seed].append(diff)

    with open("Experiments/lumc_subsample/03_50/gr_25712/diff_per_seed.pkl", "wb") as file:
        pickle.dump(diff_per_seed, file)
