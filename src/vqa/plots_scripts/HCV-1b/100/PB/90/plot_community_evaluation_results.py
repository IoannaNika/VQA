...
def main():
    ...
    for sub_directory in os.listdir(args.input_dir):
        ...
        if os.path.exists(input_file):
            ...
            for region in regions: 
                ...
                results[sub_directory][region]['n_pred_communities'] = n_pred_communities #n_pred_communities[regions == region][0]
                results[sub_directory][region]['n_true_communities'] = n_true_communities[regions == region][0]
                results[sub_directory][region]['n_pred_communities'] = results[sub_directory][region]['n_pred_communities'] #- discard_communities
    ...
    bars_homogeneity = [avg_results[subdir]['homogeneity'] for subdir in ['ab_03_97', 'ab_30_70', 'ab_50_50', 'ab_70_30', 'ab_97_03'] ]
    ...
    bars_completeness = [avg_results[subdir]['completeness'] for subdir in ['ab_03_97', 'ab_30_70', 'ab_50_50', 'ab_70_30', 'ab_97_03'] ]
    ...
    bars_ratio_communities = [avg_results[subdir]['ratio_communities'] for subdir in ['ab_03_97', 'ab_30_70', 'ab_50_50', 'ab_70_30', 'ab_97_03'] ]
    ...
    plt.xlabel('Relative abundances for the two simulated HCV-1b sequences', fontsize=35) #, fontweight ="bold")
    plt.tight_layout()
