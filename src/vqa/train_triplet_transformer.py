...
def main():
    ...
    data = TripletReads(directory='/tudelft.net/staff-umbrella/ViralQuasispecies/inika/Read_simulators/data/triplet_dataset_primers_template_excl_neg_identicals_100000')
    ...
    check_point_dir = "transformer_checkpoints/r6/"
